...
The app runs at `http://localhost:5050` and auto-shuts down after 60 seconds without a browser connection.
...
- **Auto-shutdown**: Background thread monitors heartbeat from frontend. If no heartbeat for 60s, server exits automatically.
